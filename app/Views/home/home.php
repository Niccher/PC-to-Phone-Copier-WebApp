                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <div>
                                <span class="badge bg-info me-2">
                                    <?php echo $files_count + $texts_count; ?> total items
                                </span>
                            </div>
                        ...
                        <div class="recent-tabs">
                            <ul class="nav nav-tabs nav-bordered mb-3" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" id="files-tab" data-bs-toggle="tab" href="#recent-files"
                                        role="tab">
                                ...
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" id="texts-tab" data-bs-toggle="tab" href="#recent-texts"
                                        role="tab">
                                        <i class="mdi mdi-text-box-multiple me-1"></i>
                                        Texts
                                        <span class="badge bg-success ms-1">
                                            <?php echo $texts_count; ?>
                                        </span>
                                    </a>
                                </li>
                            </ul>
                                                ...
                                                <tr>
                                                    <td class="text-center">
                                                        <span class="file-icon-box"
                                                            style="width:36px;height:36px;display:inline-flex;align-items:center;justify-content:center;border-radius:8px;background:rgba(0,0,0,0.04);">
                                                            <i
                                                                class="mdi mdi-<?php echo $iconData['icon']; ?> font-20 <?php echo $iconData['color']; ?>"></i>
                                                        </span>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td class="text-center text-nowrap">
                                                        ...
                                                        <a href="javascript:void(0);"
                                                            ...
                                                            data-date="<?php echo $fileDate; ?>" title="Share QR">
...
?>
                                                <tr>
                                                    <td class="text-center">
                                                        <span class="file-icon-box"
                                                            style="width:36px;height:36px;display:inline-flex;align-items:center;justify-content:center;border-radius:8px;background:rgba(40, 167, 69, 0.1);">
                                                            <i
                                                                class="mdi mdi-text-box-outline font-20 text-success"></i>
                                                        </span>
                                                    </td>
                                                    <td>
                                                        <h6 class="mb-0 text-truncate" style="max-width: 200px;"
                                                            title="<?php echo htmlspecialchars($textTitle); ?>">
                                                            <a href="javascript:void(0);"
                                                                class="text-reset copy-text-link"
                                                                data-text="<?php echo htmlspecialchars($text->text_content ?? ''); ?>">
                                                    ...
                                                    <td><span class="badge bg-light text-dark">
                                                            <?php echo htmlspecialchars($textSource); ?>
                                                        </span></td>
                                                    <td class="text-center text-nowrap">
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-sm btn-outline-secondary py-0 px-2 me-1 copy-text-link"
                                                            data-text="<?php echo htmlspecialchars($text->text_content ?? ''); ?>"
                                                            title="Copy">
                                                        ...
                                                        <a href="javascript:void(0);"
                                                            ...
                                                            data-date="<?php echo $textDate; ?>" title="Share QR">
                                                            <i class="mdi mdi-qrcode"></i>
                                                        </a>
                                                        <a href="<?php echo base_url('text/delete/' . $text->text_uuid); ?>"
                                                            class="btn btn-sm btn-outline-danger py-0 px-2"
                                                            title="Delete"
                                                            onclick="return confirm('Delete this text?')">
                                                            <i class="mdi mdi-delete"></i>
                                                        </a>
                                                    </td>
                                                </tr>
